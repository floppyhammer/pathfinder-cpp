...
#define PATHFINDER_LOGV(...) printf("<%s>", PATHFINDER_LOG_TAG); printf(__VA_ARGS__); printf("\n")
#define PATHFINDER_LOGD(...) printf("<%s>", PATHFINDER_LOG_TAG); printf(__VA_ARGS__); printf("\n")
#define PATHFINDER_LOGI(...) printf("<%s>", PATHFINDER_LOG_TAG); printf(__VA_ARGS__); printf("\n")
#define PATHFINDER_LOGW(...) printf("<%s>", PATHFINDER_LOG_TAG); printf(__VA_ARGS__); printf("\n")
#define PATHFINDER_LOGE(...) printf("<%s>", PATHFINDER_LOG_TAG); printf(__VA_ARGS__); printf("\n")
#endif
